...
Route::prefix('institution')->name('institution.')->group(function (): void {
    ...
    Route::middleware(['auth', 'institution_admin'])->group(function (): void {
        ...
        Route::get('reports/{report}', [InstitutionReportController::class, 'show'])
            ->middleware('institution_feature:PUBLIC_REPORTS')
            ->name('reports.show');
        Route::patch('reports/identifier-groups/resolve', [InstitutionReportController::class, 'resolveIdentifierGroup'])
            ->middleware('institution_feature:PUBLIC_REPORTS')
            ->name('reports.identifier-groups.resolve');
...
Route::prefix('sa')->name('super-admin.')->group(function (): void {
    ...
    Route::middleware(['auth', 'super_admin_access'])->group(function (): void {
        ...
        Route::delete('signal-sub-types/selected', [SignalTypeController::class, 'destroySelectedSubTypes'])->middleware('super_admin_permission:SA_SIGNAL_TYPES_UPDATE,SA_SIGNAL_TYPES_MANAGE')->name('signal-sub-types.destroy-selected');
