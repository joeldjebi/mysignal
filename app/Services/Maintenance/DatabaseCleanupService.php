...
class DatabaseCleanupService
{
    ...
    private const TABLE_METADATA = [
        'incident_report_payment_sessions' => [
            ...
            'importance' => 'Indispensable pour transformer un paiement confirmé en signalement.',
            'cleanup_impact' => 'Les paiements non finalisés ne pourront plus créer leur signalement.',
        ],
        'payments' => [
            'label' => 'Paiements signalements',
            'role' => 'Historique des paiements rattachés aux signalements UP.',
            'importance' => 'Permet le suivi financier et la preuve de paiement.',
            'cleanup_impact' => 'L’historique financier des signalements vidés disparaît.',
        ],
        'incident_report_notification_contexts' => [
            'label' => 'Contextes de notification signalement',
            'role' => 'Stocke les informations utilisées pour notifier autour des signalements.',
            'importance' => 'Aide à tracer et contextualiser les notifications envoyées.',
            'cleanup_impact' => 'Les anciens contextes de notification ne seront plus consultables.',
        ],
        'reparation_case_steps' => [
            'label' => 'Étapes dossiers réparation',
            'role' => 'Détail des actions et étapes sur les dossiers de réparation/contentieux.',
            'importance' => 'Conserve la chronologie opérationnelle des dossiers.',
            'cleanup_impact' => 'Les étapes de dossiers vidés seront supprimées.',
        ],
        'reparation_case_histories' => [
            'label' => 'Historique dossiers réparation',
            'role' => 'Historique des changements de statut et mouvements des dossiers.',
            'importance' => 'Utile pour l’audit et le suivi juridique.',
            'cleanup_impact' => 'La traçabilité historique des dossiers vidés disparaît.',
        ],
        'reparation_cases' => [
            'label' => 'Dossiers de réparation',
            'role' => 'Dossiers contentieux ouverts à partir des signalements avec dommages.',
            'importance' => 'Supporte le workflow huissier, AODA et avocat.',
            'cleanup_impact' => 'Les dossiers de réparation de test seront supprimés.',
        ],
        'incident_reports' => [
            'label' => 'Signalements',
            'role' => 'Table centrale des signalements soumis par les UP.',
            'importance' => 'Alimente les tableaux de bord, institutions, statistiques, SLA et résolution.',
            'cleanup_impact' => 'Tous les signalements de test vides seront perdus.',
        ],
        'rex_feedbacks' => [
            'label' => 'Retours d’expérience UP',
            'role' => 'Avis et retours envoyés par les UP après usage du service.',
            'importance' => 'Sert à mesurer la satisfaction et améliorer le parcours.',
            'cleanup_impact' => 'Les retours de test seront supprimés.',
        ],
        'subscription_payments' => [
            'label' => 'Paiements abonnements',
            'role' => 'Historique des paiements liés aux abonnements UP.',
            'importance' => 'Supporte le suivi financier des abonnements.',
            'cleanup_impact' => 'Les traces de paiement d’abonnement de test disparaîtront.',
        ],
        'up_subscriptions' => [
            'label' => 'Abonnements UP',
            'role' => 'Abonnements actifs, expirés ou en attente des usagers publics.',
            'importance' => 'Contrôle l’accès aux avantages liés aux formules UP.',
            'cleanup_impact' => 'Les abonnements de test seront retirés.',
        ],
        'up_discount_cards' => [
            'label' => 'Cartes réduction UP',
            'role' => 'Cartes de réduction générées pour les UP éligibles.',
            'importance' => 'Permet la vérification chez les partenaires.',
            'cleanup_impact' => 'Les cartes de test ne seront plus valides.',
        ],
        'partner_discount_transactions' => [
            'label' => 'Transactions réductions partenaire',
            'role' => 'Historique des réductions appliquées par les partenaires.',
            'importance' => 'Trace les avantages consommés par les UP.',
            'cleanup_impact' => 'Les réductions appliquées en test seront supprimées.',
        ],
        'user_notifications' => [
            'label' => 'Notifications utilisateurs',
            'role' => 'Notifications envoyées aux UP et utilisateurs concernés.',
        ...
        'device_tokens' => [
            ...
            'importance' => 'Nécessaire pour envoyer des notifications.',
            'cleanup_impact' => 'Les appareils devront se réenregistrer pour recevoir des notifications.',
        ],
        'household_invitations' => [
            'label' => 'Invitations Gbonhi',
            'role' => 'Invitations envoyées pour rejoindre un Gbonhi.',
            'importance' => 'Gère les invitations en attente et leur acceptation.',
            'cleanup_impact' => 'Les invitations de test encore ouvertes seront annulées.',
        ],
        'household_members' => [
            'label' => 'Membres Gbonhi',
            'role' => 'Lien entre un Gbonhi et ses membres UP.',
            'importance' => 'Définit qui appartient à quel Gbonhi.',
            'cleanup_impact' => 'Les rattachements membres de test seront supprimés.',
        ],
        'households' => [
            'label' => 'Gbonhi',
            'role' => 'Groupes/foyers créés par les UP.',
            'importance' => 'Supporte la gestion collective des identifiants et membres.',
            'cleanup_impact' => 'Les Gbonhi de test seront supprimés.',
        ],
        'meter_assignments' => [
            ...
            'cleanup_impact' => 'Les rattachements UP-identifiants de test disparaîtront.',
        ],
        'meters' => [
            'label' => 'Identifiants / compteurs',
            'role' => 'Identifiants utilisés pour les signalements.',
            'importance' => 'Porte les informations de localisation réutilisées lors du signalement.',
            'cleanup_impact' => 'Les identifiants de test seront supprimés.',
        ],
        'public_user_otps' => [
            'label' => 'OTP UP',
            'role' => 'Codes temporaires de connexion ou validation des UP.',
            'importance' => 'Sert à l’authentification et à la vérification ponctuelle.',
            'cleanup_impact' => 'Les codes de test encore actifs deviendront invalides.',
        ],
        'public_user_phone_verifications' => [
            'label' => 'Vérifications téléphone UP',
            'role' => 'Historique des validations de numéros de téléphone UP.',
            'importance' => 'Trace la vérification des comptes publics.',
            'cleanup_impact' => 'Les validations de test seront supprimées.',
        ],
        'public_users' => [
            'label' => 'Usagers publics',
            'role' => 'Comptes UP/UPE créés dans la plateforme.',
            'importance' => 'Base des parcours publics: signalements, abonnements, Gbonhi, notifications.',
            'cleanup_impact' => 'Les comptes publics de test et leurs données rattachées seront supprimés.',
        ],
        'contact_submissions' => [
            'label' => 'Demandes de contact',
            'role' => 'Messages envoyés depuis la page d’accueil.',
            'importance' => 'Permet au SA de suivre les prospects et demandes entrantes.',
            'cleanup_impact' => 'Les demandes de contact de test seront supprimées.',
        ],
    ];

    private const PROFILES = [
        'launch_operational' => [
            'label' => 'Données opérationnelles avant production',
            'description' => 'Vide les signalements, paiements, dossiers, notifications, retours UP, abonnements UP, cartes de réduction, compteurs, foyers et comptes UP de test. Les référentiels, institutions, rôles, permissions et utilisateurs internes restent conservés.',
            'tables' => [
                'incident_report_payment_sessions',
                'payments',
                'incident_report_notification_contexts',
        ...
        'reports_payments' => [
            ...
            'description' => 'Vide uniquement le cycle des signalements: sessions FineoPay, paiements, signalements, dossiers de réparation rattachés, notifications et REX associés.',
            'tables' => [
                'incident_report_payment_sessions',
                'payments',
                'incident_report_notification_contexts',
        ...
        'public_users' => [
            ...
            'description' => 'Vide les comptes usagers publics et les données qui leur sont rattachées. Les types d’UP et la tarification restent conservés.',
            'tables' => [
                'incident_report_payment_sessions',
                'payments',
                'incident_report_notification_contexts',
