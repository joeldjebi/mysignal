...
@section('header-badges')
    <span class="badge-soft">Rubriques structurées</span>
@endsection
            ...
            <section class="panel-card">
                <div class="d-flex justify-content-between align-items-start gap-3 mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('super-admin.landing-page.contacts.index') }}" class="btn btn-outline-dark btn-sm">Messages de contact</a>
                        <a href="{{ route('public.landing') }}" target="_blank" class="btn btn-outline-dark btn-sm">Prévisualiser</a>
                    </div>
                </div>
                            ...
                            <div id="landing-section-{{ $key }}" class="accordion-collapse collapse {{ $loop->first ? 'show' : '' }}" data-bs-parent="#landingSectionsAccordion">
                                <div class="accordion-body">
                                    <div class="form-check form-switch mb-3">
                                        ...
                                        <label class="form-check-label" for="section-active-{{ $key }}">Afficher cette rubrique</label>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            @if (in_array($key, ['page_about', 'page_contact', 'page_tv', 'page_terms', 'page_privacy'], true))
                                                ...
                                                <div class="small text-secondary mt-1">
                                                    Utilisez la barre d’outils pour mettre en forme le contenu. Le contenu enrichi est enregistré automatiquement.
                                                </div>
                                            @else
                                    ...
                                    @foreach ($section['item_groups'] as $groupKey => $group)
                                        <div class="mt-4">
                                            <div class="d-flex justify-content-between align-items-center gap-3 mb-2">
                                                ...
                                                <div class="small text-secondary">Décoche une ligne pour la masquer, vide-la pour la supprimer.</div>
                                            </div>
                                                                    ...
                                                                    <td style="min-width: {{ $field === 'body' ? '260px' : '150px' }}">
                                                                        ...
                                                                        @elseif ($key === 'page_tv' && $groupKey === 'videos' && $field === 'url')
                                                                            <div class="d-grid gap-2">
                                                                                ...
                                                                                <div class="small text-secondary">Charge une vidéo. Elle sera enregistrée dans le stockage sécurisé.</div>
                                                                            </div>
                                                                        @elseif ($key === 'partners' && $groupKey === 'items' && $field === 'url')
                                                                            ...
                                                                            <div class="d-grid gap-2">
                                                                                ...
                                                                                <div class="small text-secondary">Charge une image. Si aucun fichier n’est choisi, le logo actuel est conservé.</div>
                                                                            </div>
                                                                        @else
                ...
                <div class="d-flex justify-content-end gap-2">
                    <button class="btn btn-dark">Enregistrer les rubriques</button>
                </div>
            </section>
        </div>
        ...
        <div class="col-lg-4">
            <section class="panel-card sticky-form-card">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="small text-secondary">
                        Le logo officiel reste affiché automatiquement sur la page publique.
                    </div>
                </div>
            </section>
        </div>
