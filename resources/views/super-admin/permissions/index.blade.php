        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header">
                    <div>
                        <h5 class="modal-title fw-bold">Nouvelle permission</h5>
                        <div class="small text-secondary">Creer une permission utilisable dans les roles et affectations directes.</div>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="vstack gap-3">
                            <div>
                                ...
                                <input type="text" name="code" value="{{ old('code') }}" class="form-control" placeholder="MANAGE_PRICING" required>
                            </div>
                            <div>
    ...
    @if ($errors->any() && old('code'))
        <script>
            ...
            if (createPermissionModal) {
                bootstrap.Modal.getOrCreateInstance(createPermissionModal).show();
            }
        </script>
    @endif
@endsection
