...
@section('page-description', 'Consulter le profil, les roles et les permissions de cet utilisateur interne.')
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-12">
            <section class="panel-card">
                <div class="fw-bold mb-3">Permissions directes</div>
                @if ($systemUser->permissions->isNotEmpty())
                    <div class="row g-3">
                        @foreach ($systemUser->permissions as $permission)
                            <div class="col-lg-4">
                ...
                @else
                    <div class="text-secondary">Aucune permission directe attribuee.</div>
                @endif
            </section>
        </div>
    </div>
