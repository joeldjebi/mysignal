...
@section('title', config('app.name').' | Historique des reductions')
@section('page-title', 'Historique des reductions')
@section('page-description', 'Consultez les reductions appliquees par vos agents scanneurs et filtrez par agent, offre, statut ou periode.')
...
@section('content')
    <section class="panel-card">
        <div class="fw-bold mb-3">Historique des reductions des agents</div>
        ...
        <form method="GET" class="filter-bar">
            ...
            <div class="row g-2 align-items-end mt-1">
                ...
                <div class="col-md-6 d-flex gap-2">
                    ...
                    <a href="{{ route('partner.discount-transactions.index') }}" class="btn btn-outline-secondary w-100">RAZ</a>
                </div>
            </div>
        </form>
                ...
                <tbody>
                    @forelse ($transactions as $transaction)
                        <tr>
                            ...
                            <td>
                                <div class="fw-semibold">{{ $transaction->partnerUser?->name ?: '-' }}</div>
                                <div class="small text-secondary">{{ $transaction->partnerUser?->email ?: '-' }}</div>
                                <div class="small text-secondary">{{ $transaction->partnerUser?->phone ?: '-' }}</div>
                            </td>
                            <td>
