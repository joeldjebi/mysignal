        ...
        <div class="container shell py-3 py-lg-4">
                    ...
                    <div class="col-lg-5">
                        <div class="hero-stage">
                            ...
                            <div class="hero-stage-card">
                                ...
                                <div class="muted-copy mb-0">Consultez l’état du signalement, la réponse institutionnelle, le respect du SLA et l’évolution concrète du dossier.</div>
                            </div>
                            <div class="hero-stage-card">
                            ...
                            <div class="vstack gap-3">
                                ...
                                <div class="bullet-check">
                                    ...
                                    <div>
                                        ...
                                        <div class="muted-copy mb-0">L’usager suit le statut du dossier, la réponse apportée, le SLA appliqué et les suites éventuelles.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <div class="mini-card h-100">
                                        ...
                                        <div class="muted-copy mb-0">Le statut, le SLA et les réponses forment une lecture claire de l’avancement.</div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mini-card h-100">
            ...
            <section id="features" class="mb-4 mb-lg-5">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4"><div class="feature-card p-4 h-100"><div class="feature-art"><svg viewBox="0 0 320 180" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><rect width="320" height="180" fill="#f4f7f9"/><rect x="40" y="34" width="240" height="112" rx="28" fill="#ffffff"/><rect x="60" y="58" width="92" height="16" rx="8" fill="#d2dfe7"/><rect x="60" y="90" width="200" height="12" rx="6" fill="#e3ebf0"/><rect x="60" y="114" width="126" height="12" rx="6" fill="#e3ebf0"/><circle cx="232" cy="66" r="22" fill="#cb6f2c"/><path d="M232 54v13l9 6" stroke="#fff3eb" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"/><rect x="60" y="146" width="60" height="12" rx="6" fill="#1e5877" opacity=".18"/><rect x="128" y="146" width="90" height="12" rx="6" fill="#1e5877" opacity=".28"/></svg></div><div class="feature-icon mb-3">02</div><h3 class="h5 fw-bold">Suivi clair du dossier</h3><p class="muted-copy mb-0">Chaque signalement garde son statut, son temps de traitement, sa réponse institutionnelle, le SLA appliqué et, si besoin, la suite liée aux dommages.</p></div></div>
                        ...
                        <div class="proof-card h-100">
                            ...
                            <div class="vstack gap-3">
                                ...
                                <div class="mini-card">
                                    ...
                                    <div class="muted-copy mb-0">Voyez l’état d’avancement, la réponse institutionnelle, la résolution et le respect du SLA.</div>
                                </div>
                                <div class="mini-card">
                        ...
                        <div class="timeline-card h-100">
                            ...
                            <div class="timeline-step">
                                ...
                                <div>
                                    ...
                                    <div class="muted-copy mb-0">Vous consultez la réponse, la résolution, le respect du SLA et, si besoin, la gestion du dommage.</div>
                                </div>
                            </div>
                        </div>
                    </div>
