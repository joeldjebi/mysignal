    ...
    <div class="row g-4">
        <div class="col-xl-4">
            <section class="panel-card">
                <div class="fw-bold mb-3">Nouveau rôle</div>
                <form method="POST" action="{{ route('institution.roles.store') }}" class="vstack gap-3">
                    ...
                    @if ($authorization['canManageInstitutionPermissions'])
                        <div>
                            ...
                            <div class="small text-secondary mb-2">Choisissez les droits qui seront attribués automatiquement aux collaborateurs de ce rôle.</div>
        ...
        <div class="col-xl-8">
            <section class="panel-card">
                <div class="fw-bold mb-3">Liste des rôles</div>
