...
<body>
    @php
        ...
        $institutionUnreadNotificationsCount = $authUser
            ...
            <header class="topbar mb-4 d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    <a href="{{ route('institution.notifications.index') }}" class="notification-link {{ $activeNav === 'notifications' ? 'bg-light' : '' }}" aria-label="Notifications">
                        ...
                        @if ($institutionUnreadNotificationsCount > 0)
            ...
            async function waitForActiveServiceWorker(registration) {
                ...
                if (installingWorker) {
                    await new Promise((resolve, reject) => {
                        const timeout = window.setTimeout(() => reject(new Error('Service Worker activation timeout.')), 10000);
