...
class SuperAdminPermissionSeeder extends Seeder
{
    public function run(): void
    {
        foreach ([
            ...
            ['code' => 'SA_PRIVILEGE_CARD_TYPES_MANAGE', 'name' => 'Gerer cartes privileges', 'description' => 'Permet de parametrer les cartes privileges.'],
    ...
    private function granularPermissions(): array
    {
        $modules = [
            ...
            'SA_PRIVILEGE_CARD_TYPES' => ['Cartes privileges', 'payments'],
